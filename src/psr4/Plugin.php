...
use MediaStoreNet\WPPluginCore\Cache;
use MediaStoreNet\WPPluginCore\Log;
use MediaStoreNet\WPPluginCore\Contracts\Plugable;
use MediaStoreNet\MVC_Core\Engine;

/**
 * Abstract class representing a plugin structure.
 * Provides basic functionality for managing MVC engine, addons, hooks, and more.
 */
